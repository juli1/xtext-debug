...
public interface DomainmodelPackage extends EPackage
{
  ...
  /**
   * Returns the meta object for the containment reference list '{@link org.eclipse.xtext.example.domainmodel.domainmodel.Entity#getVars <em>Vars</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Vars</em>'.
   * @see org.eclipse.xtext.example.domainmodel.domainmodel.Entity#getVars()
   * @see #getEntity()
   * @generated
   */
