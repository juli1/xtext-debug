...
ruleShowValue
	...
	:
(
{ before(grammarAccess.getShowValueAccess().getRefAssignment()); }
(rule__ShowValue__RefAssignment)
{ after(grammarAccess.getShowValueAccess().getRefAssignment()); }
)
...
:
(
{ before(grammarAccess.getShowValueAccess().getRefXVariableDeclarationCrossReference_0()); }
(
{ before(grammarAccess.getShowValueAccess().getRefXVariableDeclarationIDTerminalRuleCall_0_1()); }
	RULE_ID{ after(grammarAccess.getShowValueAccess().getRefXVariableDeclarationIDTerminalRuleCall_0_1()); }
)
{ after(grammarAccess.getShowValueAccess().getRefXVariableDeclarationCrossReference_0()); }
)
